...
| 用途 | カラーコード | Tailwind Color Token | 使用例 |
|------|-------------|---------------------|--------|
| プライマリ（グラフ、リンク） | `#3b82f6` | `blue-600` | `bg-blue-600`, `text-blue-600`, `border-blue-600` |
| プライマリ（ホバー） | `#2563eb` | `blue-700` | `hover:bg-blue-700`, `hover:text-blue-700` |
| 成功 | `#10b981` | `green-500` | `bg-green-500`, `text-green-500` |
| エラー | `#ef4444` | `red-500` | `bg-red-50`, `text-red-600`, `dark:text-red-400` |
