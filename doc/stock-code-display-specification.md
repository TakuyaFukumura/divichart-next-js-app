...
| 銘柄名                                              | 配当金額[円]  | 割合[%] |
|--------------------------------------------------|----------|-------|
| VA L-TERM BOND (BLV)                             | ¥150,000 | 35.7  |
| VA L-TERM CORPBD (VCLT)                          | ¥100,000 | 23.8  |
| ブラジル株式ツインαファンド(毎月分配型)ツインα・コース                  | ¥50,000  | 11.9  |
| GBLX US PREFERRD (PFFD)                          | ¥30,000  | 7.1   |
| インデックスファンドMLP(毎月分配型)                             | ¥20,000  | 4.8   |
| その他                                              | ¥70,000  | 16.7  |
...
- **モバイル（~768px）**: 横スクロール可能にし、すべてのカラムを表示
- **タブレット以上**: 通常通り全カラムを表示
